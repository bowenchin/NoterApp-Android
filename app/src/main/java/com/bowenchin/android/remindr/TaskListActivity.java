...
import com.bowenchin.android.remindr.interfaces.OnEditTask;
...
public class TaskListActivity extends AppCompatActivity implements OnEditTask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirstTime()) {
            ...
            startActivity(i);
            // show dialog
            new AlertDialog.Builder(this).setTitle("Welcome to Remindr").setMessage("Add a new to-do task by tapping on the \"+\" button to get started! \n \nLearn more by going to \"Settings\".").setNeutralButton("GOT IT", null).show();
        }
    }
